...
const MobileSideBar = ({ setHandleSidebar, handleSidebar }) => {
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            console.log("Event in sidebar", event);
