...
const Footer = () => {
  ...
  const onSubmit = async (data) => {
    console.log("Footer form data", data);
    try {
      const res = await axios.post("https://getform.io/f/qaloldeb", data);
      console.log("get form res", res.data);
      alert("Thank You for Writing Us");
      reset();
    } catch (error) {
  ...
  return (
    <div className=" bg-footerGreen grid grid-cols-12 gap-2 h-auto mt-14 text-white md:pl-20 md:pr-20">
      <div className="col-span-12 md:col-span-5 w-full p-4">
        <Link to="/">
          <div className="border-b border-white pb-10 mb-10 cursor-pointer">
            <svg
              width="180"
        ...
        <p className=" text-3xl mb-5">Let's bring healthcare home</p>
        <p className="">Cupertino California</p>
        <a
          href="mailto:support@caremagix.com"
        ...
        <ul className="flex gap-8 mt-2">
          <li>
            <a href="#" title="LinkedIn">
              <div className="w-12 h-12 flex items-center justify-center rounded-full transition hover:shadow-yellow-300 shadow">
                <FaLinkedin className="w-8 h-8 text-yellow-600" />
              </div>
            </a>
          </li>
          <li>
            <a href="#" title="X">
              <div className="w-12 h-12 flex items-center justify-center rounded-full transition hover:shadow-yellow-300 shadow">
                <FaXTwitter className="w-8 h-8 text-yellow-600" />
              </div>
            </a>
          </li>
          <li>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <input
                ...
                className="border rounded w-full p-1 focus:outline-none"
              />
              {errors.firstname && (
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <PhoneInput
                    ...
                    className="w-full border border-gray-300 rounded py-1 text-black "
                  />
                )}
              />
              ...
              {errors.mobile && (
                <span className="text-sm text-red-500">
                  {errors.hospital_mobile.message}
                </span>
              )}
            </div>
          ...
          <div className="col-span-2 mt-4">
            ...
            <textarea
              ...
              className="border rounded w-full p-1 h-24"
            />
            {errors.message && (
          ...
          <button
            type="submit"
            className="mt-6 bg-yellow-500 w-40 p-2 rounded text-white cursor-pointer hover:bg-yellow-700"
          >
            Submit
          </button>
        </form>
        ...
        <div className="col-span-6 sm:col-span-3">
          ...
          <ul className="footer-list mt-2">
            <li className=" hover:underline">
              <Link to="Care-Advocate">Care Advocate</Link>
            </li>
            <li className=" hover:underline">
              <Link to="Personal-Care-Assistant">Personal Care Assistant</Link>
            </li>
          </ul>
        </div>
        <div className="col-span-6 sm:col-span-3">
          ...
          <ul className="footer-list mt-2">
            ...
            <li className=" hover:underline">
              <Link to="Health-Care-Plan">Health Care Plan</Link>
            </li>
          </ul>
        </div>
        <div className="col-span-6 sm:col-span-3">
      ...
      <div className="col-span-12 flex justify-center pt-6 pb-6">
        <p className="">2025 © All rights reserved by Caremagix</p>
      </div>
    </div>
  );
};
