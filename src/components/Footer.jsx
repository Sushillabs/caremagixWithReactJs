  ...
  return (
    <div className=" bg-footerGreen grid grid-cols-12 gap-2 h-auto mt-14 text-white md:pl-20 md:pr-20">
      <div className="col-span-12 md:col-span-5 w-full p-4">
        <div className="border-b border-white pb-10 mb-10">
          {/* <img
        ...
        <p className="">support@caremagix.com</p>
      ...
      <div className="col-span-12 md:col-span-7 p-4">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            type="submit"
            className="mt-6 bg-yellow-500 w-40 p-2 rounded text-white hover:bg-yellow-800"
          >
            Submit
          </button>
        </form>
