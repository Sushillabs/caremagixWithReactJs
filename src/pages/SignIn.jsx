    ...
    <div className="grid grid-cols-12  md:ml-48 md:mr-48 mt-10 gap-1 p-2 rounded shadow-2xl border border-gray-300">
      {!isForgot ? (
        <div className="col-span-12 md:col-span-6 md:p-6 flex  flex-col gap-3">
          ...
          <form onSubmit={handleSubmit(onSignIn)}>
            <div className="col-span-1 relative">
              ...
              <br />
              <input id="eamil" type="email" className="border border-gray-300 w-full p-2 rounded " {...register("email", { required: true })} />
            ...
            <div className="relative">
              <button type="submit" className="absolute top-6  bg-resblue w-full p-2 rounded text-white  hover:cursor-pointer hover:bg-blue-800">
                Sign In
              </button>
            </div>
          </form>
        ...
        <div className="col-span-12 md:col-span-6 md:p-6 flex  flex-col gap-3">
          ...
          <p className="text-blue-600 w-fit font-semibold hover:cursor-pointer hover:underline" onClick={() => setIsForgot(false)}>
            Sign In
          </p>
          ...
          <form onSubmit={handleSubmit(onSignInReset)}>
            <div className="col-span-1 relative">
              <label htmlFor="email"> Email </label>
              <br />
              <input id="email" type="email" className="border border-gray-300 w-full p-2 rounded " {...register("email", { required: true })} />
              {errors.email && <p>Emaile is required</p>}
            </div>
            <div className="relative">
              <button type="submit" className="absolute top-6 bg-resblue w-full p-2 rounded text-white  hover:cursor-pointer hover:bg-blue-800">
